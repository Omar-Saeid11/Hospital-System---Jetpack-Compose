package com.example.hospitalsystem.presentation.screens.analysis
...
@Composable
fun AnalysisHomeScreen(navController: NavController) {
...
@Composable
fun Prev() {
    AnalysisHomeScreen(navController = NavController((LocalContext.current)))
}