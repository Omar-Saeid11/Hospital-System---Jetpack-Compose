...
fun AppNavGraph(navController: NavHostController, startDestination: String) {
    NavHost(navController = navController, startDestination = startDestination) {
        ...
        composable(Screen.CreateCallScreen.route) { CreateCallScreen(navController = navController) }
        composable(Screen.RequestCanceledScreen.route) { RequestCanceledScreen(navController = navController) }
        ...
        composable(Screen.AddEmployeeScreen.route){ AddEmployeeScreen(navController = navController)}
    }
}